...
```bash
git clone https://github.com/AgenticPortfolioX/JobApply.git
cd ApplyPilot
pip install -e ".[dev]"
...
1. Check existing [issues](https://github.com/AgenticPortfolioX/JobApply/issues) to avoid duplicating work
